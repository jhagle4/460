...
class LexicalAnalyzer 
{
	...
	int DFA[11][22] =
	  {
	    {1,2,3,4,5,5,5,ERROR_T,ERROR_T,EQUALTO_T,6,7,DIV_T,MULT_T,LPAREN_T,RPAREN_T,SQUOTE_T,ERROR_T,0,5,8,NEWLINE_T},
	    ...
	    {IDENT_T,IDENT_T,5,5,5,10,LISTOP_T,5,Predicate,IDENT_T,IDENT_T,IDENT_T,IDENT_T,IDENT_T,IDENT_T,IDENT_T,IDENT_T,IDENT_T,IDENT_T,5,IDENT_T,IDENT_T}
	  };
	string line;
	int linenum;
	int pos;
